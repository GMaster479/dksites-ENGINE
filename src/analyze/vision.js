...
const SYSTEM = `You are labeling photographs of ONE local business so a website generator can
...
image shows it). If an image is unclear, say so rather than inventing a subject.
...
Return STRICT JSON only — no prose, no markdown fences:
{
  "photos": [
    {
      ...
      "tags": ["<3-6 short lowercase tags: subject, setting, indoor/outdoor, people, food, signage, equipment, etc>"],
  ...
  "heroIndex": <the "i" of the single best hero image, or null if none is suitable>,
  "logoIndex": <the "i" of the image that is the business's logo, or null if none is>,
 ...
 */
export async function describePhotos(photos = []) {
